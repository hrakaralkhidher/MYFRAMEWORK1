...
public class GETBooks {
    //This is first way to privide baseURI
    ...
    @Test(description = "Given a baseURI When we make GET call to /books Then Verify status code is 200")
    ...
    @Test(description = "Biven a baseURI When we make the GET call to /books and query parameters as type=crime(doesn't exust) Then Verify  status code is 400")
    ...
    @Test(description = "Given  a baseURI When we make GET call to /books and use query param limit220(out of limin) Then verify status code is 400")
    ...
    void userRetrieveSingleBookInformation(){
        ...
        //Given
        RequestSpecification request = given().pathParams("bookId",bookIdFromUtils);
