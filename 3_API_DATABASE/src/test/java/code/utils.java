...
public class utils {
    ...
    public static String generateBearerToken(){
        ...
        //We generate client name and client email address here so that we can use it in request body
        ...
        //we put the json format into a String
        String requestPayload=json.toString();

        //Given
        //We need to provide 3 things: requestBody, Header and any params(path or query)
